...
if ( ! class_exists( 'Fusion_Builder_Front' ) ) {
	...
	class Fusion_Builder_Front {
		...
		public function init() {
			...
			add_action( 'heartbeat_received', __CLASS__ . '::heartbeat_lock_post', 10, 2 );
		...
		public static function lock_post() {
			...
			$lock_user_id = isset( $_GET['take-over'] ) ? null : wp_check_post_lock( $post_id );
